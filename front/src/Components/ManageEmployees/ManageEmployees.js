          ...
          <div className={"row" + c + " rowData"}>
            ...
            <div className="col0 col3">
              <div className="action">
                <div title="Show Employee Projects">
                  <Link
                    className="link-to pointer"
                    to={{
                      pathname: "/EmployeeProjectsReport",
                      state: {
                ...
                <div title="Show Employee KPIs">
                  <Link
                    className="link-to pointer"
                    to={{
                      pathname: "/KpisEmployee",
                      state: {
                        fromNotifications: this.state.employees.data[i].id,
                      },
                    }}
                  >
                    <FontAwesomeIcon color={"black"} icon={faTasks} />
                  </Link>
                </div>
                <div title="Edit">
                  <FontAwesomeIcon
                    color={"#e55d87"}
                    onClick={() => {
                      this.editEmployee(this.state.employees.data[i].id);
                    }}
                    className="pen"
                    icon={faPen}
                  />
